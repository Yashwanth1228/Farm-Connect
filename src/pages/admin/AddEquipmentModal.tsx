...
import {
  ...
  Title,
  UploadBox,
} from "../../components/admin/styles/add_equipment";
import {
      ...
      <Modal>
        ...
        <LeftPanel>
          <div>
            ...
            <PanelText>Manage your agricultural fleet efficiently.</PanelText>
          </div>
          ...
          <Form>
            ...
            <Row>
              ...
              <div>
                ...
                <Input
                  type="text"
                  value={formData.hydraulicFlow}
                  placeholder="GPM/LPM"
                  onChange={(e) =>
                    setFormData({ ...formData, hydraulicFlow: e.target.value })
                  }
                />
              </div>
            </Row>
